...
router.post("/",
    ...
    async (req, res) => {
        ...
        try {
            ...
            //     from: "mannu123@gmail.com", // sender address
            //     to: createUser.email, // list of receivers
            //     subject: `Welcome to ABC system ${createUser.firstname} ${createUser.lastname}`, // Subject line
            //     text: `Hello ${createUser.firstname}`, // plain text body
            //     html: "<b>Hello world?</b>", // html body
            // });

            let info1 = await transporter.sendMail({
                from: "mannu123@gmail.com", // sender address
                to: ["admin1@gmail.com","admin2@gmail.com","admin3@gmail.com","admin3@gmail.com" ,"admin4@gmail.com","admin5@gmail.com"], // list of receivers
